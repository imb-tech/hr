            ...
            return (
              <li key={stepIdx} className="relative flex w-full items-center">
                <button
                  ...
                  className={cn(
                    "group flex flew-row w-full cursor-pointer items-center justify-center gap-x-3 rounded-large py-2.5",
                    stepClassName,
                  ...
                  {...props}
                >
                  <div className="group flex w-full cursor-pointer flex-row items-center gap-x-3 rounded-large">
                    ...
                    <div className="max-w-full flex-1 text-start">
                      ...
                      <div
                        className={cn(
                          "text-xs font-extralight text-default-500 transition-[color,opacity] duration-300 group-active:opacity-80 lg:text-sm",
                          {
                  ...
                  {stepIdx < steps.length - 1 && !hideProgressBars && (
                    <div
                      aria-hidden="true"
                      className="pointer-events-none w-10 flex-none items-center"
                      style={{
                        // @ts-ignore
                        "--idx": stepIdx,
                      }}
                    >
                      {isVertical ? (
                        <div
                          className={cn(
                            "relative w-0.5 h-10 bg-[var(--inactive-bar-color)] transition-colors duration-300 ml-4 mt-2 dark:bg-default-400",
                            "after:absolute after:block after:w-0.5 after:h-0 after:bg-[var(--active-border-color)] after:transition-[height] after:duration-300 after:content-['']",
                            {
                              "after:h-10": stepIdx < currentStep,
                            },
                          )}
                        />
                      ) : (
